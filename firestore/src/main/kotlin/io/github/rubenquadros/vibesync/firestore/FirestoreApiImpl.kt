...
class FirestoreApiImpl : FirestoreApi {
    ...
    private val firestore: Firestore by lazy {
        ...
        val options = FirebaseOptions.builder()
            .setCredentials(GoogleCredentials.fromStream(FileInputStream("/Users/rquadros/Documents/Ruben/git_tree/Vibesync-Server/admin_access.json")))
            .setDatabaseUrl("https://default.asia-southeast1.firebasedatabase.app.firebaseio.com")
            .build()
